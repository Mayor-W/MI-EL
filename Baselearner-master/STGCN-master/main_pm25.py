...
from utils import generate_dataset, load_pm25_data, get_normalized_adj
...
if __name__ == '__main__':
    ...
    A, X, means, stds = load_pm25_data()

    # 6:2:2
    split_line1 = int(X.shape[2] * 0.6) + 1
    split_line2 = int(X.shape[2] * 0.8) + 1
    ...
    # Test
    net = torch.load('weights/pm25/STGCN_pm25_12step_best.th')
    ...
    # np.save('output/pm25/STGCN_pm25_testoutput_12step.npy', test_out_unnormalized)