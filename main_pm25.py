...
from model.MI_EL_pm25 import STEnsembleModel
...
date_rng = pd.date_range(start='2014-05-01 00:00:00', end='2014-08-31 23:00:00', freq='H')
...
STARIMA_Ftrain3 = np.load('baselearner_features/pm25/3step/STARIMA_trainoutput_3step.npy')
STARIMA_Fval3 = np.load('baselearner_features/pm25/3step/STARIMA_valoutput_3step.npy')
STARIMA_Ftest3 = np.load('baselearner_features/pm25/3step/STARIMA_testoutput_3step.npy')
STARIMA_Ftrain6 = np.load('baselearner_features/pm25/6step/STARIMA_trainoutput_6step.npy')
STARIMA_Fval6 = np.load('baselearner_features/pm25/6step/STARIMA_valoutput_6step.npy')
STARIMA_Ftest6 = np.load('baselearner_features/pm25/6step/STARIMA_testoutput_6step.npy')
STARIMA_Ftrain12 = np.load('baselearner_features/pm25/12step/STARIMA_trainoutput_12step.npy')
STARIMA_Fval12 = np.load('baselearner_features/pm25/12step/STARIMA_valoutput_12step.npy')
STARIMA_Ftest12 = np.load('baselearner_features/pm25/12step/STARIMA_testoutput_12step.npy')

STKNN_Ftrain3 = np.load('baselearner_features/pm25/3step/STKNN_trainoutput_3step.npy')
STKNN_Fval3 = np.load('baselearner_features/pm25/3step/STKNN_valoutput_3step.npy')
STKNN_Ftest3 = np.load('baselearner_features/pm25/3step/STKNN_testoutput_3step.npy')
STKNN_Ftrain6 = np.load('baselearner_features/pm25/6step/STKNN_trainoutput_6step.npy')
STKNN_Fval6 = np.load('baselearner_features/pm25/6step/STKNN_valoutput_6step.npy')
STKNN_Ftest6 = np.load('baselearner_features/pm25/6step/STKNN_testoutput_6step.npy')
STKNN_Ftrain12 = np.load('baselearner_features/pm25/12step/STKNN_trainoutput_12step.npy')
STKNN_Fval12 = np.load('baselearner_features/pm25/12step/STKNN_valoutput_12step.npy')
STKNN_Ftest12 = np.load('baselearner_features/pm25/12step/STKNN_testoutput_12step.npy')

STGCN_Ftrain3 = np.load('baselearner_features/pm25/3step/STGCN_trainoutput_3step.npy')
STGCN_Fval3 = np.load('baselearner_features/pm25/3step/STGCN_valoutput_3step.npy')
STGCN_Ftest3 = np.load('baselearner_features/pm25/3step/STGCN_testoutput_3step.npy')
STGCN_Ftrain6 = np.load('baselearner_features/pm25/6step/STGCN_trainoutput_6step.npy')
STGCN_Fval6 = np.load('baselearner_features/pm25/6step/STGCN_valoutput_6step.npy')
STGCN_Ftest6 = np.load('baselearner_features/pm25/6step/STGCN_testoutput_6step.npy')
STGCN_Ftrain12 = np.load('baselearner_features/pm25/12step/STGCN_trainoutput_12step.npy')
STGCN_Fval12 = np.load('baselearner_features/pm25/12step/STGCN_valoutput_12step.npy')
STGCN_Ftest12 = np.load('baselearner_features/pm25/12step/STGCN_testoutput_12step.npy')

# Concatenate the output features Ftrain:Mtrain*3*36*6  Fval:Mval*3*36*6  Ftest:Mtest*3*36*6
...
if __name__ == '__main__':
    ...
    # Set parameters
    num_learners = 3
    adj_matrix = np.load("data/pm25/pm25_adj_mat.npy") # adjacency matrix based on spatial Euclidean distance
    adj_matrix = adj_matrix - np.eye(adj_matrix.shape[0])

    sim_matrix = np.load("data/pm25/pm25_sim_mat.npy") # adjacency matrix based on the similarity of monitoring values
    sim_matrix = sim_matrix - np.eye(sim_matrix.shape[-1])

    eigenmaps_k = 8 # embedding dimensions of spatial embedding branch
    timeembeddings_k = 12 # embedding dimensions of temporal embedding branch
    num_embeddings = [] # temporal attributes
    ...
    for epoch in range(epochs):
        ...
        if validation_losses[-1] >= val_epoch_best_loss:
            ...
            torch.save(net.state_dict(), 'weights/pm25/' + NAME + '.th')
    ...
    testmodel12.load_state_dict(torch.load('weights/pm25/MI_EL_pm25_12step_best.th'))
    testmodel12.eval()
    test_out12 = testmodel12(Ftest12, test_indices)
    Calculate_Acc(test_target.numpy(), test_out12.detach().numpy())
    # np.save('output/pm25/MI_EL_pm25_testoutput_12step.npy', test_out12.detach().numpy())
    ...
    # np.save('output/pm25/MI_EL_pm25_testoutput_6step.npy', test_out6.detach().numpy())

    print('————3 step————')
    testmodel3 = STEnsembleModel(num_learners, adj_matrix, sim_matrix, eigenmaps_k, 8, TimeInfo,
                                 num_embeddings, max_len, d_model, 3)
    testmodel3.load_state_dict(torch.load('weights/pm25/MI_EL_pm25_3step_best.th'))
    testmodel3.eval()
    test_out3 = testmodel3(Ftest3, test_indices)
    Calculate_Acc(test_target.numpy()[:, :, :3], test_out3.detach().numpy())
    # np.save('output/pm25/MI_EL_pm25_testoutput_3step.npy', test_out3.detach().numpy())